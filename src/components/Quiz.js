...
const Quiz = () => {
  ...
  const handleAnswer = (selectedAnswer) => {
    ...
    setAnswerHistory((prevHistory) => [
      ...prevHistory,
      { questionIndex: currentQuestionIndex, isCorrect }, // Track correctness
    ]);
  ...
  return (
    ...
    className="absolute top-24 right-4 px-4 py-2 bg-red-500 text-white font-semibold rounded-lg shadow-md hover:bg-red-600 transition"
  >
    Finish
  </button>
